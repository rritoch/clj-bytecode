...
public class T_CONSTANT_MethodType_info extends T_CPInfo {
	/**
	 * 
	 */
	...
	public T_CONSTANT_MethodType_info() {
		tag = (new T_U1()).add(7);
		descriptor_index = new T_U2();
	}
	
	private T_CONSTANT_MethodType_info(T_U2 v) {
		tag = (new T_U1()).add(7);
		descriptor_index = v;
		info = new T_U1List();
	...
	public T_CPInfo set(InputStream is) throws IOException {
		...
		return new T_CONSTANT_MethodType_info(v);
	}
}
