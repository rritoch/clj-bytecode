...
public class T_CONSTANT_Integer_info extends T_CPInfo {
	/**
	 * 
	 */
	...
	public T_CONSTANT_Integer_info() {
		tag = (new T_U1()).add(3);
		bytes = new T_U4();
	}
	
	private T_CONSTANT_Integer_info(T_U4 v) {
		tag = (new T_U1()).add(3);
		bytes = v;
	...
	public T_CPInfo set(InputStream is) throws IOException {
		...
		return new T_CONSTANT_Integer_info(v);
	}
